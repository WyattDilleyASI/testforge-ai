...
export const THEMES = {
  ...
  // ── AURORA BOREALIS ────────────────────────────────────────────────────────
  // Slow-flowing green and purple northern lights on a dark arctic sky.
  // Flag `_aurora: true` renders a canvas-based wave animation.
  aurora: {
  ...
  // ── VAPORWAVE ──────────────────────────────────────────────────────────────
  // Retro 80s sunset with perspective grid lines.
  // Flag `_vaporwave: true` renders a canvas-based grid + sun animation.
  vaporwave: {
  ...
  // ── FIREFLIES ──────────────────────────────────────────────────────────────
  // Warm dark forest with floating, softly glowing particles.
  // Flag `_fireflies: true` renders a canvas-based particle animation.
  fireflies: {
  ...
  // ── LAVA LAMP ──────────────────────────────────────────────────────────────
  // Slow, warm color morphing background via CSS gradient animation.
  // Flag `_lavaLamp: true` is read by App to inject the gradient animation.
  lavaLamp: {
  ...
  // ── SYNTHWAVE ──────────────────────────────────────────────────────────────
  // Pink/blue gradient that slowly oscillates. Retro-futuristic feel.
  // Flag `_synthwave: true` is read by App to inject the gradient animation.
  synthwave: {
